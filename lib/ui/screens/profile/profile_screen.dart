...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("My Profile",style: latoBold,),
      ),
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: 30,),
              Text(user?.username ?? "-",style: latoBold.copyWith(fontSize: 25),),
              SizedBox(height: 8,),
              Text("ID: ${user?.id}",style: latoRegular.copyWith(fontSize: 15),),
              Divider(color: gray2,),
              Text("Menu",style: latoBold,),
              ListTile(
                title: Text("Watchinglist Movie",style: latoRegular,),
                trailing: Icon(Icons.chevron_right),
              ),
              ListTile(
                title: Text("Favourite Movie",style: latoRegular,),
                trailing: Icon(Icons.chevron_right),
              ),
              ListTile(
                title: Text("Logout",style: latoRegular,),
                trailing: Icon(Icons.chevron_right),
                onTap: (){
